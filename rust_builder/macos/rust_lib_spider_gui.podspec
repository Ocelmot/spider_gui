...
# Run `pod lib lint rust_lib_spider_gui.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'rust_lib_spider_gui'
  s.version          = '0.0.1'
...
A new Flutter FFI plugin project.
  ...
  s.script_phase = {
    ...
    :script => 'sh "$PODS_TARGET_SRCROOT/../cargokit/build_pod.sh" ../../rust rust_lib_spider_gui',
    :execution_position => :before_compile,
    :input_files => ['${BUILT_PRODUCTS_DIR}/cargokit_phony'],
    # Let XCode know that the static library referenced in -force_load below is
    # created by this build step.
    :output_files => ["${BUILT_PRODUCTS_DIR}/librust_lib_spider_gui.a"],
  }
  s.pod_target_xcconfig = {
    'DEFINES_MODULE' => 'YES',
    # Flutter.framework does not contain a i386 slice.
    'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386',
    'OTHER_LDFLAGS' => '-force_load ${BUILT_PRODUCTS_DIR}/librust_lib_spider_gui.a',
  }
end